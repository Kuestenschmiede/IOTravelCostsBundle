...
namespace con4gis\RoutingExpensesBundle\ContaoManager;

use con4gis\CoreBundle\con4gisCoreBundle;
use con4gis\RoutingExpensesBundle\con4gisRoutingExpensesBundle;
...
class Plugin implements RoutingPluginInterface, BundlePluginInterface, ConfigPluginInterface
{
    ...
    {
        return [
            BundleConfig::create(con4gisRoutingExpensesBundle::class)
