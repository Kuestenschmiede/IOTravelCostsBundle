...
$GLOBALS['TL_LANG'][$strName]['overPositions'] = ['Iterim stops', 'Allow entering iterim stops'];
$GLOBALS['TL_LANG'][$strName]['timeAtStop'] = ['Time at interim Stop', 'Time for an interim stop.'];
$GLOBALS['TL_LANG'][$strName]['addTimes'] = ['Input for wait time', 'Adds an input field for wait time.'];
...
$GLOBALS['TL_LANG'][$strName]['inputPlaceholder'] = ['Placeholder for input', 'Enter a custom placeholder for the input.'];
